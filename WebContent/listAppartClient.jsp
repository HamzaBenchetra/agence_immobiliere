...
<a href="/AgenceImmobiliere/DetailsAppart?id=${Appart.getIdAppart()}" class="btn-floating halfway-fab waves-effect waves-light red"><i class="material-icons">add</i></a>					        </div>
