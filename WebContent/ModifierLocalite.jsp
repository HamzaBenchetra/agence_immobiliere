    ...
    <div id="right-panel" class="right-panel">
		...
		<div class="card">
                      <div class="card-header">
                        <strong>Modifier une localité</strong>
                      </div>
                      <div class="card-body card-block">
                        <form action="" method="post" class="">
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="idLocalite" class=" form-control-label">Localite</label></div>
                            <div class="col-12 col-md-9">
                              <select name="idLocalite" id="idLocalite" class="form-control">
                                <option value="0">Selectionner une localite</option>
                          ...
                          <div class="form-group"><label for="NVnomLocalite" class=" form-control-label">Nouveau nom </label><input type="text" id="NVnomLocalite" name="NVnomLocalite" placeholder="Nouveau nom de la localité" class="form-control"></div>
