<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<%@page import="Model.Preaviss" %>
	<%
	ArrayList<Preaviss> allR = (ArrayList<Preaviss>)request.getAttribute("ListPRV");
%>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/AgenceImmobiliere/Agent.jsp"> Espace Agent<!-- <img src="images/logo.png" alt="Logo"> --></a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="/AgenceImmobiliere/Agent.jsp"> <i class="menu-icon fa fa-dashboard"></i>Accueil </a>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="/AgenceImmobiliere/ListeRDVAgent">Mes rendez-vous</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
...
<div class="content mt-3">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Liste des rendez-vous</strong>
                        </div>
                        <div class="card-body">
	 ...
	 <input type="hidden" name="idPreavis" id="what" value="<%= allR.get(i).getIdpreavis()%>">
				...
				<td> <input  value="Modifier Preavis" type="submit" id=/></td>
